...
export class SeedTableParameters1634480926303 implements typeorm.MigrationInterface {
    public async up(queryRunner: typeorm.QueryRunner): Promise<void> {
        await queryRunner.query(`
            ...
            ('SITE-PROMO-BUTTON-URL', '/pagina/2'),
            ...
            ('SITE-FOOTER-YOUTUBE-URL', '#'),
            ('SITE-FOOTER-EMAIL-SHOW', 'NO'),
            ('SITE-FOOTER-EMAIL-ADDRESS-HTML5', '<a href="mailto:#">teste@teste.com.br</a>'),
            ('SITE-FOOTER-WHATSAPP-SHOW', 'YES'),
            ('SITE-FOOTER-WHATSAPP-NUMBER-HTML5', '<a href="tel:(99) 99999-9999">(99) 99999-9999</a>'),
